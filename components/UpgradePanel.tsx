    ...
    <div className="flex flex-col gap-3">
      <div className="flex flex-wrap gap-2">
        <button
          ...
          disabled={busy !== null}
          className="brand-gradient rounded-xl px-5 py-2.5 text-sm font-semibold text-white transition hover:opacity-90 disabled:opacity-60 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan"
        >
          {monthlyLabel}
        </button>
        <button
          ...
          disabled={busy !== null}
          className="rounded-xl border border-borderline px-5 py-2.5 text-sm font-semibold transition hover:border-cyan disabled:opacity-60 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan"
        >
          {annualLabel}
        </button>
      </div>
      ...
      {foundingLeft === null || foundingLeft > 0 ? (
        <button
          ...
          disabled={busy !== null}
          className="self-start rounded-xl border border-cyan/50 px-5 py-2.5 text-sm font-semibold text-cyan transition hover:border-cyan disabled:opacity-60 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan"
        >
          {foundingLabel}
          {foundingLeft !== null ? (
